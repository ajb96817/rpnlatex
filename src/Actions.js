...
class InputContext {
  constructor(app_component, pyodide_interface, settings) {
    this.app_component = app_component;
    this.pyodide_interface = pyodide_interface;
    ...
    for(const command of commands) {
      ...
      try {
        ...
        if(!['stack_underflow', 'stack_type_error', 'prefix_argument_required'
          ...
          // (only flash the screen).  Others errors will be shown in red.
  ...
  // TODO: offending_expr should be offending_expr_path (or just remove it)
