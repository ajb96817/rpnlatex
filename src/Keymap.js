...
const keybinding_table = {
  ...
  config: {
    ...
    'D': "config debug_mode toggle",  // undocumented
    'E': "config eink_mode",
    'f': "fullscreen on",
    'F': "fullscreen off",
    'g': "config outline_stack_items toggle",
    'G': "config outline_document_items toggle",
    'i': "config inline_math toggle",
    'I': "config mode_indicator toggle",
    'M': "config hide_mouse_cursor toggle",
  ...
  infix: {
    ...
    'a': "apply_infix",
    'b': "multi_infix \\bullet",
    'c': "multi_infix \\cap",
    'C': "multi_infix \\circledcirc",
    'd': "pass;swap;push \\dagger;superscript false;swap;concat",  // 'pass' drops the prefix argument if any
    'D': "multi_infix \\oplus",  // [D]irect sum
    'e': "multi_infix ,\\dots,",
    'f': "conjunction if",
    'F': "conjunction iff",
    'g': "multi_infix \\gets",
    'G': "multi_infix \\Leftarrow",
    'i': "multi_infix \\,\\vert\\,;delimiters \\langle \\rangle",  // <x | y>
    'j': "multi_infix \\Join",
    'k': "multi_infix \\,\\vert\\,",  // x | y  ([k]onditional)
    '|': "alias k",
    'l': "multi_infix \\parallel",
    ...
    ' ': "alias s",
    'S': "multi_infix \\circledast",
    't': "multi_infix \\to",
    'T': "multi_infix \\longrightarrow",
    'u': "multi_infix \\cup",
    'v': "multi_infix \\vee",
    'V': "multi_infix \\veebar",
    'w': "multi_infix \\wedge",
    'W': "multi_infix \\barwedge",
    'x': "autoparenthesize 2;multi_infix \\times",
    'X': "multi_infix \\otimes",
    '=': "multi_infix \\Rightarrow",
    '+': "multi_infix \\Longrightarrow",
    '-': "multi_infix \\ominus",
    '.': "pass;autoparenthesize 2;multi_infix \\cdot",
    ',': "multi_infix ,",
    '(': "multi_infix ,;delimiters ( )",
    '<': "multi_infix ,;delimiters \\langle \\rangle",
    '[': "multi_infix ,;delimiters [ ]",
    '{': "multi_infix ,;delimiters \\{ \\}",
    '>': "multi_infix \\cdots",
    '*': "pass;autoparenthesize 2;multi_infix *",
    '^': "pass;autoparenthesize 2;multi_infix \\star",
    ':': "multi_infix \\colon",
    ';': "multi_infix semicolon",
    ...
    '/': "pass;autoparenthesize 2;multi_infix /",
    "\\": "pass;autoparenthesize 2;multi_infix \\backslash",
    '%': "multi_infix \\div",
    'Tab': "multi_infix \\quad",
    '_': "multi_infix \\_",
  ...
  // NOTE: since [=] doesn't trap digits for a prefix_argument,
  // these bindings don't use multi_infix, so items are only joined
  // in pairs with "relational" operators.
  relational: {
    '0': "integer 0;infix =",
    '1': "integer 1;infix =",
  ...
  // [|][w]: swap array rows (see do_start_swap_rows())
  swap_rows: {
    '[digit]': "finish_swap_rows",
    '*': "finish_swap_rows"
  },
